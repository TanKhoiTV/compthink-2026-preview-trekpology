...
export function initOnlineClient(onStateChange, onGameError) {
    ...
    socket.on("game:error", (payload) => {
        onGameError === null || onGameError === void 0 ? void 0 : onGameError(payload.message);
