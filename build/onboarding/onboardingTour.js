...
*/
import { startSpotlightTour } from "./spotlight.js";
import { showResultsReveal } from "./resultsReveal.js";
    ...
    return [
        ...
        },
        {
            ...
            target: () => {
                ...
                return (_b = (_a = document
                    .querySelector('.draft-center-card [data-card-tag="food"]')) === null || _a === void 0 ? void 0 : _a.closest(".draft-center-card-wrapper")) !== null && _b !== void 0 ? _b : null;
            },
            title: "🍜 Thẻ Ẩm thực",
        ...
        },
        {
            ...
            target: () => {
                var _a, _b;
                return (_b = (_a = document
                    .querySelector('.draft-center-card [data-card-tag="culture"]')) === null || _a === void 0 ? void 0 : _a.closest(".draft-center-card-wrapper")) !== null && _b !== void 0 ? _b : null;
            },
            title: "🏛️ Thẻ Văn hóa",
        ...
        },
        {
            ...
            target: () => {
                var _a, _b;
                return (_b = (_a = document
                    .querySelector('.draft-center-card [data-card-tag="action"]')) === null || _a === void 0 ? void 0 : _a.closest(".draft-center-card-wrapper")) !== null && _b !== void 0 ? _b : null;
            },
            title: "🧭 Thẻ Khám phá",
        ...
        },
        {
            ...
            allowSkipResults: true,
            advance: {
                waitUntil: () => ctx.isReplayPausedForEvent() || ctx.getPhase() === "result",
            },
 ...
 */
export function maybeStartOnboarding(ctx) {
    if (active || hasSeenOnboarding())
        return active;
    if (ctx.isLoggedIn())
        return false; // đã đăng nhập sẵn → bỏ qua slice auth
    startTour(ctx);
    return true;
}
/** Gắn 1 lần: nút [data-tutorial-open] (vd "Hướng Dẫn Chơi") → mở lại tour. */
export function initTourLauncher(ctxFactory) {
    document.addEventListener("click", (event) => {
        var _a, _b;
        const trigger = (_b = (_a = event.target) === null || _a === void 0 ? void 0 : _a.closest) === null || _b === void 0 ? void 0 : _b.call(_a, "[data-tutorial-open]");
        if (!trigger)
            return;
...
function removeSkipFab() {
    ...
    fabPoll = 0;
    skipFab === null || skipFab === void 0 ? void 0 : skipFab.remove();
    skipFab = null;
}
/**
 ...
 */
function startSkipFabWatcher(ctx, onReveal) {
    removeSkipFab();
    const ensure = () => {
...
export function startTour(ctx) {
    ...
    const reveal = () => {
        removeSkipFab();
        ctx.resumeReplay();
        controller === null || controller === void 0 ? void 0 : controller.stop("skip"); // gỡ overlay hướng dẫn TRƯỚC khi cleanup set null
        cleanup();
